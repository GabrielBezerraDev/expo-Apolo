...
const handleTakePicture = useCallback(async () => {
    ...
    if (!GEMINI_API_KEY) {
        Alert.alert("Erro de Configuração", "A chave da API do Gemini não foi encontrada.");
        return;
    }
    ...
    try {
      ...
      Alert.alert("Erro na API", "Não foi possível processar a imagem. Verifique o console.");
    }
}, [/* onTextExtracted */]);
